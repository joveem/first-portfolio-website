...
{
    let body = $("body").get(0);
    body.style.setProperty("--home-background-url", "url(https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/home/background-out-of-order-01.jpg)")
}

function ApplyDarkHomeBackground()
{
    let body = $("body").get(0);
    body.style.setProperty("--home-background-url", "url(https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/home/background-out-of-order-02.jpg)")
}
