...
{
    DoSmoothImageChange("https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/jovdev-website-joveem-01-06.png", 0.3);
}

function ApplyDarkToMainImage()
{
    DoSmoothImageChange("https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/jovdev-website-joveem-02-06.png", 0.3);
}

function ApplyLightToMainImageInstantaneously()
{
    SetImageInstantaneously("https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/jovdev-website-joveem-01-06.png", 0);
}


function ApplyDarkToMainImageInstantaneously()
{
    SetImageInstantaneously("https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/jovdev-website-joveem-02-06.png", 0);
}
...
function ApplyLightLightSwitch()
{
    ...
    // lightSwitchImage.attr("src", 'https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/light-switch-on.png');
    let lightSwitchImage = $('.div-light-switch');
    lightSwitchImage.css('background-image', 'url(https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/light-switch-on.png)');
}

function ApplyDarkLightSwitch()
{
    // let lightSwitchImage = $(".light-switch");
    // lightSwitchImage.attr("src", 'https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/light-switch-off.png');
    let lightSwitchImage = $('.div-light-switch');
    lightSwitchImage.css('background-image', 'url(https://jovdev-website-bucket-01.s3.amazonaws.com/public/images/about/light-switch-off.png)');
}
